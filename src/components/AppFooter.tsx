...
import logoUrl from "./../assets/logo.png"; // ajusta a ../assets/logo.png si tu estructura lo requiere

type FooterLink = { label: string; to: string };

type AppFooterProps = {
  appName?: string;
  quickLinks?: FooterLink[]; // pásalo [] si no quieres enlaces
  tagline?: string; // subtítulo (opcional)
  version?: string; // badge opcional (e.g. "v1.0.0")
};
