...
export function Inform() {
  ...
  // ✅ Si no hay ventas NI gastos en el rango, mostramos estado vacío
  const hasAnyData = (rawDocs?.length ?? 0) > 0 || (geItems?.length ?? 0) > 0;
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-pink-50 to-indigo-100 flex flex-col">
      <main className="flex-grow p-6 sm:p-12 max-w-7xl mx-auto w-full">
        ...
        {/* Controles de rango: siempre visibles */}
        ...
        {!hasAnyData ? (
          // 🧪 Estado vacío compacto (sin navegación)
          <section className="mb-10">
            <EmptyStateCTA
              variant="section"
              title="Aún no hay datos en este rango"
              description="Cuando registres ventas o gastos en este periodo, verás aquí tus informes, KPIs y gráficas."
              to="#"
              showButton={false}
          ...
          <>
            ...
            {/* ===== Bloques por categoría/atributos ===== */}
